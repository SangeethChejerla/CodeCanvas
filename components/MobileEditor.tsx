...
const MobileEditor: React.FC<MobileEditorProps> = () => {
  ...
  <div className="flex py-2 px-3 md:px-20 items-center justify-between">
    ...
    >
      <ToggleGroupItem disabled={currTab === "html"} value="html">
        HTML
      </ToggleGroupItem>
      <ToggleGroupItem disabled={currTab === "css"} value="css">
        CSS
      </ToggleGroupItem>
      <ToggleGroupItem disabled={currTab === "javascript"} value="javascript">
        JavaScript
      </ToggleGroupItem>
    </ToggleGroup>
    <div>
      <Button
        ...
        onClick={() => {
          navigator.clipboard
            ...
            .then(() => {
              toast.success(`Copied ${currTab} code`);
            });
        }}
      >
    ...
    <ScrollArea className="h-full w-full">
      <ScrollArea className="h-full w-full">
        <CodeMirror
          ...
          extensions={[
            loadLanguage(currTab as "html" | "css" | "javascript") as Extension,
          ]}
        />
      </ScrollArea>
